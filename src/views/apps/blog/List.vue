                ...
                <div class="col-12 md:col-4">
                    <div class="p-3">
                        <div class="surface-100 cursor-pointer border-round">
                            <div class="relative">
                                <img :src="contextPath + data.coverImage" class="w-full" :alt="data.description.split(' ', 1)" />
                                <img :src="contextPath + data.profile" class="cardImage flex absolute w-4rem h-4rem" :alt="data.description.split(' ', 1)" />
                            </div>
                            <div class="p-3">
