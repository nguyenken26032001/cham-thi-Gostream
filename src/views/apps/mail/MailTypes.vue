    ...
    >
        ...
        <Column style="min-width: 4rem">
            <template #body="{ data }">
                ...
                <Avatar v-else @click="onNavigateToDetailPage(data.id)" :id="data.id" :image="contextPath + `demo/images/avatar/${data.image ? data.image : '.png'}`" class="cursor-pointer"></Avatar>
            </template>
        </Column>
        <Column style="min-width: 4rem">
            <template #body="{ data }">
