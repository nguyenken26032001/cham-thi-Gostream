    ...
    <div class="flex flex-column h-full">
        <div class="flex align-items-center border-bottom-1 surface-border p-3 lg:p-6">
            <div class="relative flex align-items-center mr-3">
                <img :src="contextPath + 'demo/images/avatar/' + user.image" :alt="user.name" class="w-4rem h-4rem border-circle shadow-4" />
        ...
        <div class="user-message-container p-3 md:px-4 lg:px-6 lg:py-4 my-auto overflow-y-auto" style="max-height: 53vh">
            <div v-for="message in user.messages" :key="message">
                <div v-if="message.ownerId !== 123" class="grid grid-nogutter mb-4">
                    <div class="mr-3 mt-1">
                        <img :src="contextPath + 'demo/images/avatar/' + user.image" :alt="user.name" class="w-3rem h-3rem border-circle shadow-4" />
                    </div>
                    <div class="col mt-3">
