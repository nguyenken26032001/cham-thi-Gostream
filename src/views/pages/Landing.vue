    ...
    <div class="relative overflow-hidden flex flex-column justify-content-center">
        ...
        <div class="landing-wrapper">
            <div class="flex align-items-center justify-content-between relative lg:static py-6 px-4 mx-0 md:px-7 lg:px-8 lg:py-6 lg:mx-8">
                ...
                <div class="align-items-center flex-grow-1 hidden md:flex absolute md:static w-full md:px-0 z-3 shadow-2 md:shadow-none fadein" :style="{ top: '80px', right: '0%' }">
                    <ul class="list-none p-3 md:p-0 m-0 ml-auto flex md:align-items-center select-none flex-column md:flex-row cursor-pointer surface-card md:surface-ground">
                        <li>
                            <a @click="smoothScroll('#home')" v-ripple class="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a @click="smoothScroll('#apps')" v-ripple class="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                <span>Apps</span>
                            </a>
                        </li>
                        <li>
                            <a @click="smoothScroll('#features')" v-ripple class="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                <span>Features</span>
                            </a>
                        </li>
                        <li>
                            <a @click="smoothScroll('#pricing')" v-ripple class="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                <span>Pricing</span>
                            </a>
                        </li>
                        <li>
            ...
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 z-2">
                <div id="home" class="grid grid-nogutter justify-content-between align-items-center mb-6 py-6 md:mb-8 md:py-8">
                    ...
                    <div class="col-12 md:col-7 flex-order-0 md:flex-order-1 mb-6 md:mb-0 border-round">
                        <img :src="contextPath + `demo/images/landing/${darkMode ? 'dashboard-dark' : 'dashboard-light'}.png`" alt="" class="w-full h-full border-round shadow-2 animation-duration-1000 fadeinright" />
                    </div>
                </div>
                ...
                <div id="apps" class="my-6 md:my-8">
                    ...
                    <div class="flex flex-column lg:flex-row align-items-center justify-content-between mt-8 gap-8">
                        <div class="flex flex-column align-items-center">
                            <img :src="contextPath + `demo/images/landing/${darkMode ? 'chat-dark' : 'chat-light'}.png`" alt="chat" class="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                            <span class="block text-900 text-lg font-semibold mt-4">Chat</span>
                        </div>
                        <div class="flex flex-column align-items-center">
                            <img :src="contextPath + `demo/images/landing/${darkMode ? 'mail-dark' : 'mail-light'}.png`" alt="chat" class="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                            <span class="block text-900 text-lg font-semibold mt-4">Mail</span>
                        </div>
                        <div class="flex flex-column align-items-center">
                            <img :src="contextPath + `demo/images/landing/${darkMode ? 'kanban-dark' : 'kanban-light'}.png`" alt="chat" class="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                    ...
                    <div class="grid mt-8">
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-components.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-community.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-productivity.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-accessibility.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-support.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-mobile.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-theme.svg`" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                            <div class="box p-4 w-full surface-card surface-border border-1 border-round">
                                <img :src="contextPath + `demo/images/landing/icon-ts.svg`" alt="components icon" class="block mb-3" />
