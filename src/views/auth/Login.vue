            ...
            <div class="flex flex-column">
                <span class="p-input-icon-left w-full mb-2">
                    ...
                    <InputText id="email" type="text" class="w-full md:w-25rem" placeholder="Email"
                        v-model.trim="data.email" required="true" autofocus
                        :class="{ 'p-invalid': submitted && !data.email }" />
                </span>
                ...
                <span class="p-input-icon-left w-full mb-2">
                    ...
                    <InputText id="password" type="password" class="w-full md:w-25rem" placeholder="Password"
                        v-model.trim="data.password" required="true" :class="{ 'p-invalid': submitted && !data.email }" />
                </span>
