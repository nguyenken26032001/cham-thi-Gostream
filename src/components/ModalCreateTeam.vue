    ...
    <Dialog v-model:visible="openCreateTeam" :style="{ width: '700px' }" header="Tạo Form" :modal="true" class="p-fluid">
        <div class="card flex">
            <div class="flex flex-column gap-2 w-full">
                ...
                <InputText class="inputForm mb2 gap-2" id="describe" type="text" v-model="form.describe" placeholder="Mô tả" />
            </div>
        </div>
        <div class="card flex">
            <div class="flex flex-column w-full">
                <div v-for="(option, index) in defaultOptions" :key="index" class="p-field-checkbox mb-2 flex justify-content-between align-items-center w-full">
                    <div class="p-field-checkbox mb-2 flex align-items-center" style="flex: 0 1 370px">
                        <InputText class="inputForm mb2" type="text" required="true" v-model="option.label" placeholder="Nhập tên trường" />
                    </div>
                    <div class="p-field-checkbox mb-2 flex justify-content-between align-items-center">
                        <Dropdown v-model="option.type" :options="type" optionLabel="label" optionValue="value" optionIcon="icon" class="p-dropdown p-component" style="min-width: 150px" />
                        <Button icon="" class="p-button-text" disabled="true" />
                    </div>
                </div>
                <div v-for="(option, index) in customOption" :key="index" class="p-field-checkbox mb-2 flex justify-content-between align-items-center w-full">
                    <div class="p-field-checkbox mb-2 flex align-items-center" style="flex: 0 1 370px">
                        <InputText class="inputForm mb2" type="text" required="true" v-model="option.label" placeholder="Nhập tên trường" />
                    </div>
                    <div class="p-field-checkbox mb-2 flex justify-content-between align-items-center">
        ...
        <div class="flex">
            <Button label="Tạo form" type="submit" icon="pi pi-check" class="p-button-text submit-btn" @click="createLink" />
